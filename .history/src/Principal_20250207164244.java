...
public class Principal {
    public static void main(String[] args) {
        ...
        // Número de funcionários após remoção
        ...
        funcionarios.forEach(func -> {
            ...
            System.out.println("Salário: " + currencyFormatter.format(func.getSalario()));
        ...
        funcionarios.forEach(func -> System.out
                .println(func.getNome() + " ganha "
                        + func.getSalario().divide(salarioMinimo, 2, BigDecimal.ROUND_HALF_UP) + " salários mínimos"));
    }
}
